            ...
            <Container>
                <Row className='align-items-center'>
                    ...
                    <div className="wow fadeInRight" data-wow-duration="2s" data-wow-delay="0.5s">
                        <Link to="https://www.facebook.com/profile.php?id=100012385380960" target="_blank"><FacebookIcon /></Link>
                        <Link to="https://www.instagram.com/hamasa.11/" target="_blank"><InstagramIcon /></Link>
                        <Link to="https://www.linkedin.com/in/mohamed-mahmoud-8b1538254/" target="_blank"><LinkedInIcon /></Link>
                        </div>
                    </Col>
                </Row>
                <div className="copyright wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.5s">
                    <p>© 2022 Mohamed Mahmoud</p>
