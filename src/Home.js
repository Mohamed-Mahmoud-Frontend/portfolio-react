...
function Home() {
  ...
  const sendEmail = (e) => {
    ...
    e.preventDefault();
    emailjs.sendForm('service_jjawxja', 'template_fbunvns', form.current, 'MbZEIrSCCztRFLrO1')
      .then((result) => {
        ...
        <Container>
          ...
          <Row className="align-items-center">
            <Col md={6} sm={12} className="wow slideInLeft" data-wow-duration="2s" data-wow-delay="0.1s">
              <div>
                <p><span>Email :</span> mohamedmahmoud.h13@gmail.com</p>
                <p><span>Phone :</span> 01018162567</p>
                <p><span>Address :</span>Qlyub</p>
              </div>
            </Col>
              ...
              <div>
                <form ref={form} onSubmit={sendEmail}>
                  <div className="d-flex">
                    <input type="tex t" name="name" placeholder="Name" />
